...
const PremiumInvoiceService = {
    generatePremiumInvoicePDF: (data) => {
        return new Promise((resolve, reject) => {
            ...
            try {
                ...
                doc.font('Helvetica').fontSize(14).text('Thank you for purchasing this premium subscription. For more information or any inquiries please contact 0712345677', 50, 650)
                // finalize
                const buffers = [];
